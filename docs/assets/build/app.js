...
/* harmony import */ var _jelly_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jelly-scroll */ "./src/assets/scripts/jelly-scroll.js");


// Initialize
_jelly_scroll__WEBPACK_IMPORTED_MODULE_0__["JellyScroll"].init({
    selectors: {
...
/*!********************************************!*\
  !*** ./src/assets/scripts/jelly-scroll.js ***!
  \********************************************/
/*! exports provided: JellyScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JellyScroll", function() { return JellyScroll; });
/* harmony import */ var _libs_normalize_wheel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/normalize-wheel */ "./src/assets/scripts/libs/normalize-wheel.js");
/* harmony import */ var _utilities_decorators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/decorators */ "./src/assets/scripts/utilities/decorators.js");
/* harmony import */ var _utilities_objects__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/objects */ "./src/assets/scripts/utilities/objects.js");
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/TweenMax.js");
...
let JellyScroll = (function() {
    ...
    let setOptions = function(options){
        self = Object(_utilities_objects__WEBPACK_IMPORTED_MODULE_2__["objectsMergeDeep"])(self, options);
    }
    ...
    let setScroll = function(e){
        ...
        self.scroll.curr += Object(_libs_normalize_wheel__WEBPACK_IMPORTED_MODULE_0__["normalizeWheel"])(e).spinY*self.scroll.spinFactor;
        verifyScrollLimits();
    }
    ...
    let animateSkew = function(e) {
        if(self.state.isScrolling || self.state.isTouchMove ) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_3__["TweenLite"].to(self.selectors.elements, 1,{
    ...
    let animateSkewToIdle = function() {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenLite"].to(self.selectors.elements, 0.4,{ skewY: 0,  overwrite: 5});
    }
    ...
    let animateScrollTo = function(){
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenLite"].to(self.selectors.container ,0.5,{
            y:-self.scroll.curr,
            overwrite: 5, // preexisting
            onComplete: function() {
     ...
     */
    let updateMaxScrollOnResize = Object(_utilities_decorators__WEBPACK_IMPORTED_MODULE_1__["debounce"])(function(){
...
/***/ "./src/assets/scripts/libs/normalize-wheel.js":
/*!****************************************************!*\
  !*** ./src/assets/scripts/libs/normalize-wheel.js ***!
  \****************************************************/
/*! exports provided: normalizeWheel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/assets/scripts/utilities/decorators.js":
/*!****************************************************!*\
  !*** ./src/assets/scripts/utilities/decorators.js ***!
  \****************************************************/
...
/***/ "./src/assets/scripts/utilities/objects.js":
/*!*************************************************!*\
  !*** ./src/assets/scripts/utilities/objects.js ***!
  \*************************************************/
/*! exports provided: isObject, objectsMergeDeep */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isObject", function() { return isObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "objectsMergeDeep", function() { return objectsMergeDeep; });
/**
 * Simple object check.
 * @param item
 * @returns {boolean}
 ...
 * @param ...sources
 */
function objectsMergeDeep(target, ...sources) {
    ...
    if (isObject(target) && isObject(source)) {
        for (const key in source) {
            if (isObject(source[key])) {
                ...
                objectsMergeDeep(target[key], source[key]);
            } else {
    ...
    return objectsMergeDeep(target, ...sources);
}
